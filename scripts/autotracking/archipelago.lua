...
function onItem(index, item_id, item_name, player_number)
    ...
    for _, item_pair in pairs(item) do
        ...
        if item_obj then
            ...
            elseif item_obj.Type == "progressive" then
				if item_code == "sword" or item_code == "triforce" or item_code == "wallet" or item_code == "sv_keys" 
				or item_code == "et_key_pieces" or item_code == "lmf_key" or item_code == "ac_keys" 
				or item_code == "lmf_key" or item_code == "ssh_key" or item_code == "fs_keys" or item_code == "sk_key" then
            ...
            elseif item_obj.Type == "consumable" then
				if item_code == "crystals" then
					item_obj.AcquiredCount = item_obj.AcquiredCount + 5 * (tonumber(item_pair[3]) or 1)
                else
